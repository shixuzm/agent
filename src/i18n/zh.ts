const zh = {
  ...
  "settings.memory.desktopOnly": "记忆管理仅在桌面端可用",
  "settings.memory.total": "记忆总数",
  "settings.memory.size": "数据库大小",
  "settings.memory.clear": "清空所有记忆",
  "settings.memory.clearConfirm": "确定清空？此操作不可撤销。",
  "settings.memory.clearSuccess": "已清空所有记忆",

  // ─── 上下文管理 ──────────────────────────────────────────────────────
  "settings.context.title": "上下文管理",
  "settings.context.window": "上下文窗口大小（tokens）",
  "settings.context.contextWindow": "上下文窗口",
  "settings.context.checkpointThreshold": "检查点阈值",
  "settings.context.rebuildThreshold": "重建阈值",
  "settings.context.recentMessagesRatio": "近期消息比例",
  "settings.context.memoryRatio": "记忆比例",
  "settings.context.taskProgressRatio": "任务进展比例",

  // ─── 设置标签与分区 ──────────────────────────────────────────────────
  "settings.search": "搜索设置...",
  "settings.tabs.general": "通用",
  "settings.tabs.agents": "智能体",
  ...
  "settings.general.provider": "提供商",
  "settings.general.temperature": "温度",
  "settings.general.maxTokens": "最大 Token 数",
  "settings.agents.title": "智能体",
  "settings.agents.customAgents": "自定义智能体",
  "settings.agents.newAgent": "新建智能体",
  "settings.agents.editAgent": "编辑智能体",
  "settings.agents.deleteAgent": "删除智能体",
  "settings.agents.name": "名称",
  "settings.agents.description": "描述",
  "settings.agents.role": "角色",
  "settings.agents.systemPrompt": "系统提示",
  "settings.agents.skills": "技能",
  ...
  "settings.compose.title": "Compose 模式",
  "settings.compose.enabled": "启用 Compose",
  "settings.compose.autoExecute": "自动执行步骤",
  "settings.compose.maxSteps": "最大步骤数",
  "settings.commands.dream": "/dream — 从近期会话中提取持久知识",
  "settings.commands.distill": "/distill — 从近期工作中发现可复用工作流",
  "settings.commands.compose": "/compose <spec> — 运行 spec 驱动的完整开发生命周期",
} as const;
